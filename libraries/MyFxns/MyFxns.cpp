...
*/
void MyFxns::SetMotorPWM(MOTOR_ID_ENUM motor_id, int pwm_value, int direction)
{
	if (motor_id == MotorA)
	{
...
*/
void MyFxns::SetMotor(int ChannelA, int ChannelB, int PWM_Channel, int pwm_value, int direction)
{
	//Set the direction
	if (direction == 1)
	{
...
/*	
  ...
  the fundamentals.
*/
void MyFxns::SendCANMessage(int data[])
{
	String datastring;
	String temp;
...
*/
void MyFxns:: SetMotorDir(MOTOR_DIR_ENUM direction)
{
 ...
 */
signed int MyFxns:: GetJoystickValue(int volt)
{
		//int jmx  = V;
	int x=0;
...
*/
MOTOR_DIR_ENUM MyFxns:: GetDirection(int Val)
{
...
*/	
int MyFxns:: button_Push( int pressed)
{  
...
*/
void MyFxns:: runMotorA(MOTOR_DIR_ENUM direction, int anaADVal)
{
...
*/
int MyFxns:: TM3(int RunTask_10ms)
{
...
/*
*/
int MyFxns:: CentertoZero(int maxvolt, int pwrin)
{
 ...
 */ 
float MyFxns:: pwrToPrct(int power)
{
...
//
int MyFxns:: prctToPwr(float prcnt)
{
	float val;
	val = prcnt / 100;
	//Serial.println(pwr);
...
//
float MyFxns:: prctToRPM(float prcnt)
{
	float val;
	val = prcnt / 100;
	//Serial.println(val);
